...
<html>
    ...
    <body background="background1.jpg">
        ...
        <table align = "center" cellspacing ="15" style = "border:inset;border-radius:40px">
            ...
            <tr>
                <td>Complaint id</td>
                <td><input type="text" name="complaintidtext" class = "texttheme"></td>
           
            <td>Complaint detail</td>
            <td><textarea name="complaintdetailtext" class = "textareatheme"></textarea></td>
            </tr>
            <tr>
                <td>Complaint date</td>
                <td><input type="date" name="datetext" class="texttheme"></td>
                 <td>Complaint time</td>
                <td><input type="time" name="timetext" class = "texttheme"></td>
            </tr>
                <tr align ="center">
                <td colspan ="3">
